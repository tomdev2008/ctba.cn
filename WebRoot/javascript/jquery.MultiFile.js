   ...
   MultiFile: function( options /* Object */ ){
    ...
    return $(this).each(function(group_count){
     if(this._MultiFile) return; this._MultiFile = true;
       ...
       // Bind a new element
       MF.addSlave = function( slave, slave_count ,save_value){
        ...
        slave.name =slave.name +"_"+slave.i+"_"+save_value ;
        // Clear value
       // $(slave).val('').attr('value','')[0].value = '';
        ...
        $(slave).change(function(){
          ...
          if(ERROR!=''){
            ...
            MF.n--;
            MF.addSlave(newEle[0], this.i,this.value);
          ...
          // Bind functionality
          MF.addSlave( newEle[0], this.i+1,this.value );
       ...
       MF.addToList = function( slave ){
        ...
        // Insert label
        MF.labels.append(
         //r.append('[', b, ']&nbsp; 上传到小组相册 <input type="checkbox" name=check_'+1+' checked="true"/>', a)//.prepend(slave.i+': ')
