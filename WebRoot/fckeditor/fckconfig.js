...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/silver/';//+ 'skins/famfamfamAluminum/' ;
...
FCKConfig.DefaultLanguage		= 'zh-cn' ;//缺省语言
FCKConfig.ContentLangDirection	= 'ltr' ;//默认文字方向,="ltr/rtl"
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Image','Flash','Table','SpecialChar']
] ;
...
//字体列表中的字体名
FCKConfig.FontNames		= '宋体;魏碑;微软雅黑;黑体;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
//字体大小中的字号列表
