 ...
 * 
 */
public class StrutsFieldChecks {

	/**
	 * Commons Logging instance.
	 */
	private static final Log log = LogFactory.getLog(StrutsFieldChecks.class);
	...
	// * <ul>
	// * <li>Variable <code>allowslashes</code> can be set to
	// * <code>true</code> or <code>false</code> to control whether
	// * two slashes are allowed - default is <code>false</code> (i.e.
	// * two slashes are NOT allowed).</li>
	// * <li>Variable <code>nofragments</code> can be set to
	// * <code>true</code> or <code>false</code> to control whether
	// * fragments are allowed - default is <code>false</code> (i.e.
	// * fragments ARE allowed).</li>
	// * <li>Variable <code>allowallschemes</code> can be set to
	// * <code>true</code> or <code>false</code> to control if all
	// * schemes are allowed - default is <code>false</code> (i.e. all
	// * schemes are NOT allowed).</li>
	// * <li>Variable <code>schemes</code> can be set to a comma
	// * delimited list of valid schemes. This value is ignored if
	// * <code>allowallschemes</code> is set to <code>true</code>.
	// * Default schemes allowed are "http", "https" and "ftp" if this
	// * variable is not specified.</li>
	// * </ul>
	// *
	// * @param bean
	// * The bean validation is being performed on.
	// * @param va
	// * The <code>ValidatorAction</code> that is currently
	// * being performed.
	// * @param field
	// * The <code>Field</code> object associated with the
	// * current field being validated.
	// * @param errors
	// * The <code>ActionMessages</code> object to add errors
	...
	//	 
	// if ("true".equalsIgnoreCase(field.getVarValue("allowslashes"))) {
	// options += UrlValidator.ALLOW__SLASHES;
	// }
	//	 
