 ...
 * @author ChenChangRen
 */
public class BlogBlogentryDAOTest extends DAOTestBase {

	BlogBlogentryDAO instance;

	@Before
	public void setUp() {
		instance = (BlogBlogentryDAO) Guice.createInjector(new ServiceModule())
				.getInstance(BlogBlogentryDAO.class);
	}
	...
	public void testFindById() {
		...
		Integer id = 0;
		BlogEntry result = instance.findById(id);
		assertEquals(null, result);

		List<BlogEntry> list = instance.findAll();
	...
	public void testSave() throws IllegalAccessException,
		...
		List<BlogEntry> newList = instance.findAll();
