 ...
 * @author ChenChangRen
 */
public class ImageModelDAOTest extends DAOTestBase {

	ImageModelDAO instance;

	@Before
	public void setUp() {
		instance = (ImageModelDAO) Guice.createInjector(new ServiceModule())
				.getInstance(ImageModelDAO.class);
	}

	@Test
	public void testFindAll() {
		System.out.println("findAll");
		List<ImageModel> result = instance.findAll();
	...
	public void testFindById() {
		...
		Integer id = 0;
		ImageModel result = instance.findById(id.intValue());
		assertEquals(null, result);

		List<ImageModel> list = instance.findAll();
	...
	public void testSave() throws IllegalAccessException,
		...
		List<ImageModel> newList = instance.findAll();
